...
```text
/home/krisp/terrarium-project/terrarium_history.db
```

Recente historie is beschikbaar via:

```text
http://192.168.24.166:8080/api/history
```

De database bewaart maximaal 5000 recente records en wordt niet in Git
opgenomen.
